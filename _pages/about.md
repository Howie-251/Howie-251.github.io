...
**IBG Marketplace, DiDi**  
*Algorithm Transaction Strategy, advised by Zihao Lu*  
*Mar. 2026 - Present*
...
- Modeled human reward signals and online feedback as optimizable reward targets, improving order-hold effectiveness while reducing reliance on exhaustive policy search.
...
**CTO-Emerald-Nova-Agent, Ant Group**  
*Research Intern in GUI Agent / LLM Assistant Evaluation, advised by Chenyi Zhuang*  
*Oct. 2025 - Mar. 2026*

- Led **MiniAppBench** and **MiniAppEval**, an LLM-powered assistant benchmark and static/dynamic evaluation framework for interactive HTML MiniApps.
...
**LLM-Based Scientific Discovery: An Evolutionary Framework for Searching High-Dimensional Error-Correcting Codes**  
*In preparation, Shanghai AI Laboratory / Shanghai Innovation Institute*  
*Dec. 2025 - Present*
...
M.S. student, Computer Science and Technology, John Hopcroft Center for Computer Science  
*Sep. 2025 - Mar. 2028 (expected)*  
Advisor: [Prof. Shuai Li](https://shuaili8.github.io/)
...
- Top Honors for the Graduation Thesis at Tongji University (**Top 0.2%**).
